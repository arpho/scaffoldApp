...
@Component({
  selector: 'app-wyscout-login',
  templateUrl: './wyscout-login.component.html',
  styleUrls: ['./wyscout-login.component.scss'],
})
export class WyscoutLoginComponent implements OnInit {
